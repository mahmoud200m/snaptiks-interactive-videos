            ...
            <div class="row">
              <div class=" col-xs-12">
              	<div class="text-center mgbt-xs-10">
                	<a class="btn vd_btn vd_bg-facebook vd_round-btn btn-sm  mgr-10" href="https://facebook.com/snaptiks" target="_blank"><i class="fa fa-facebook fa-fw "></i></a>
                    <!-- <a class="btn vd_btn vd_bg-googleplus vd_round-btn btn-sm  mgr-10"><i class="fa fa-google-plus fa-fw"></i></a> -->
                    <a class="btn vd_btn vd_bg-twitter vd_round-btn btn-sm mgr-10" href="https://twitter.com/snaptiks" target="_blank"><i class="fa fa-twitter fa-fw "></i></a>                    
                </div>              
                <div class="copyright text-center">
                	<p>info@snaptiks.com</p>
