...
/*  GENERAL SETTING  */
	...
	$author = 'S'; // for author meta data: <meta name="author" content="$author; ">
	$website_name = 'Snaptiks'; // for closing title every page: <title>$title;  | $website_name;</title> 
	$footer_message = 'Copyright &copy;2014 Snaptiks Inc. All Rights Reserved'; // Set Copyright message on footer
...
/*  HEADER AND FOOTER SETTING  */
	...
	$footer = 'footer-4'; // 'footer-1' or 'footer-2' or 'footer-3' or 'footer-4' ,or other 'header-*' located at templates/footers/$footer.tpl.php	
